...
window = tk.Tk("C:\\Users\\L30809.NYPSIT.000\\Desktop\\hello-fb-logo.png")
#helv36 = tk.Font(family='Helvetica', size=36, weight='bold')
window.geometry('500x500')
window.title("Registration Form")

imge=Image.open("C:/Users/L30809.NYPSIT.000/Desktop/hello-fb-logo.png")
...
label1 = tk.Label(window,text="Student Registeration Form",relief="solid",width=30,font=("arial",19,"bold"))
